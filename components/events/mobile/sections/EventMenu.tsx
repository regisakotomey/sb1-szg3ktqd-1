...
import EditEventForm from '@/components/forms/mobile/EditEventForm';
...
export default function EventMenu({
  ...
  if (showEditForm) {
    return <EditEventForm event={event} onClose={handleEditComplete} />;
  }

  if (!isOpen && !showDeleteConfirm && !showReportForm) return null;
    ...
    return (
      <>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-xl z-50 overflow-hidden">
          <div className="p-6">
            <h3 className="text-lg font-semibold mb-2">Supprimer l'événement</h3>
  ...
  if (showReportForm) {
    return (
      <>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-xl z-50 overflow-hidden">
          <div className="p-6">
            <h3 className="text-lg font-semibold mb-4">Signaler l'événement</h3>
