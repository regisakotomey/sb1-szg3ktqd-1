...
import { Share2, Edit, Trash2, Flag, ImagePlus, Calendar, Briefcase, Store } from 'lucide-react';
import { useState } from 'react';
import EventForm from '@/components/forms/mobile/EventForm';
import OpportunityForm from '@/components/forms/mobile/OpportunityForm';
import ShopForm from '@/components/forms/mobile/ShopForm';
import AdSpotForm from '@/components/forms/mobile/AdSpotForm';
import EditPlaceForm from '@/components/forms/mobile/EditPlaceForm';
    ...
    return (
      <>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-xl z-50 overflow-hidden">
          <div className="p-6">
            <h3 className="text-lg font-semibold mb-2">Supprimer le lieu</h3>
  ...
  if (showReportForm) {
    return (
      <>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-xl z-50 overflow-hidden">
          <div className="p-6">
            <h3 className="text-lg font-semibold mb-4">Signaler le lieu</h3>
