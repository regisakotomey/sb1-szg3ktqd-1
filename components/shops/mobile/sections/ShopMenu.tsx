...
import { Share2, Edit, Trash2, Flag, ImagePlus, ShoppingBag } from 'lucide-react';
import { useState } from 'react';
import AdSpotForm from '@/components/forms/mobile/AdSpotForm';
import ProductForm from '@/components/forms/mobile/ProductForm';
import EditShopForm from '@/components/forms/mobile/EditShopForm';
...
export default function ShopMenu({
  ...
  if (showEditForm) {
    return <EditShopForm shop={shop} onClose={handleEditComplete} />;
  }

  if (showAdSpotForm) {
    return <AdSpotForm onClose={() => setShowAdSpotForm(false)} shopId={shopId} />;
  }

  if (showProductForm) {
    return <ProductForm onClose={() => setShowProductForm(false)} shopId={shopId} />;
  }
    ...
    return (
      <>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-xl z-50 overflow-hidden">
          <div className="p-6">
            <h3 className="text-lg font-semibold mb-2">Supprimer la boutique</h3>
  ...
  if (showReportForm) {
    return (
      <>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-xl z-50 overflow-hidden">
          <div className="p-6">
            <h3 className="text-lg font-semibold mb-4">Signaler la boutique</h3>
