...
interface AdSpotCommentsProps {
  adSpotId: string;
}

export default function AdSpotComments({ adSpotId }: AdSpotCommentsProps) {
  ...
  const fetchComments = async () => {
    try {
      const response = await fetch(`/api/ads/${adSpotId}/comments`);
  ...
  const handleLike = async (commentId: string, isLiked: boolean) => {
    ...
    try {
      const response = await fetch(`/api/ads/comments/${commentId}/like`, {
