...
export default function OpportunityComments({ opportunityId }: OpportunityCommentsProps) {
  ...
  const handleLike = async (commentId: string, isLiked: boolean) => {
    ...
    try {
      const response = await fetch(`/api/opportunities/comments/${commentId}/like`, {
