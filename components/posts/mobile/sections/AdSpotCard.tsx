...
export default function AdSpotCard({ adSpot, onClick }: AdSpotCardProps) {
  ...
  return (
    <div
      onClick={onClick}
      className="flex-none w-[80px] cursor-pointer group"
    >
      <div className="aspect-[9/16] relative rounded-lg overflow-hidden">
        ...
        {adSpot.creator && (
          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/50 to-transparent p-1">
            <h3 className="text-white text-[10px] font-medium truncate">
              {adSpot.creator.name}
            </h3>
